...
python manage.py test apps.accounts.tests apps.companies.tests apps.audit.tests apps.drivers.tests apps.vehicles.tests apps.cargo.tests apps.documents.tests
