# FreteHub — Plataforma Inteligente de Logística com IA

## Identidade da Marca
* **Nome**: FreteHub
* **Posicionamento**: *"FreteHub é o hub inteligente de fretes que conecta cargas, motoristas, transportadoras e dados em tempo real."*
* **Proposta de Valor**: *"Reduzir custos logísticos, aumentar previsibilidade, melhorar rastreabilidade e automatizar decisões operacionais usando tecnologia e inteligência artificial."*
* **Slogan Principal**: *"O hub inteligente que conecta cargas, motoristas e transportadoras."*
...
- **Administrador**: `admin@fretehub.com` | Senha: `AdminPassword123`
- **Cliente PF**: `pf_client@fretehub.com` | Senha: `ClientPassword123`
- **Cliente PJ**: `pj_client@fretehub.com` | Senha: `ClientPassword123`
- **Motorista**: `driver@fretehub.com` | Senha: `DriverPassword123`
- **Transportadora**: `carrier@fretehub.com` | Senha: `CarrierPassword123`
- **Suporte/Financeiro/Logístico**: `<perfil>@fretehub.com` | Senha: `OperatorPassword123`
